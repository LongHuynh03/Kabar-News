import { StyleSheet, TextInput, Text, View, Image, FlatList, ScrollView, Pressable, ActivityIndicator, ToastAndroid, TouchableOpacity } from 'react-native'
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.boxSearch}>
                <Image source={require('./Image/VectorSearch.png')} style={styles.imgsearch} />
                <TextInput style={styles.textInput} placeholder={"Search"} onChangeText={(text) => countDownSearch(text)} />
                <Image source={require('./Image/VectorFilter.png')} style={styles.imgsearch} />
            </View>
