...
const Login = (props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.boxUser, { justifyContent: 'space-between' }, { marginTop: 9.5 }]}>
        <View style={[styles.boxUser, { justifyContent: 'center', alignItems: 'center' }]}>
        ...
        <Text style={[styles.textUser, { color: '#5890FF' }]}>Forgot the password?</Text>
      </View>
      ...
      <View style={styles.textError}>
        ...
        <Text style={[styles.textUser,styles.textError_1]} onPress = {SignUp}>Sign Up</Text>
      </View>
      </View>
    </View>
  )
