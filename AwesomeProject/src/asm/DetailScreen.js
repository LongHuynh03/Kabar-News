    ...
    return (
        <View style={styles.container}>
            <View style={styles.tabBar}>
                ...
                <Image style={styles.imgTabBar} source = {require('./Image/ImageSetting.png')}/>
            </View>
            <View style={styles.boxHeader}>
                ...
                <View style={styles.boxHeader_2}>
                    ...
                    <Text style={styles.header_2}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</Text>
                </View>
            </View>
            ...
            <View style={styles.boxButtonPage}>
                ...
                <TouchableOpacity style={styles.buttonPage} onPress = {() => changPages(true)}>
                    <Text style={styles.textButtonPage}>News</Text>
                    {
                        isnews ? 
                        <View style={styles.boxIsNews}></View>
                        : null
                    }
                </TouchableOpacity>
                <TouchableOpacity style={styles.buttonPage} onPress = {() => changPages(false)}>
            ...
            <View style={styles.boxAddNews}>
                ...
                <Image style={styles.imgAddNews} source={require('./Image/ImageAddNews.png')} />
                </TouchableOpacity>
            </View>
        </View>
    )
